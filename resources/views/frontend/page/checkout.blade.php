...
@section('body')
    ...
    @include('frontend.component.breadcum', ['pageName'=>'Checkout'])
    <!-- .breadcumb-area end -->
    @push('style')
                    ...
                    <div class="order-area">
                        ...
                        <ul class="total-cost">
                            ...
                            @if (Session::has('coupne'))
                                <li>Discount <span class="pull-right"><strong> (-) ৳ {{ Session::get('coupne')['discount'] }}</strong></span></li>
                                <li>Total<span class="pull-right">৳ {{ Session::get('coupne')['balance'] }} <del class="text-danger">৳ {{ Session::get('coupne')['cart_total'] }}</del></span></li>
                            @else
