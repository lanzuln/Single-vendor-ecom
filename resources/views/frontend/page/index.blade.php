...
@section('body')
                        ...
                        @foreach ($category as $item)
                            <div class="featured-wrap">
                                <div class="featured-img">
                                    <img src="{{ !empty($item->category_image) ? asset($item->category_image) : asset('avator.png') }}" alt="" width="300">
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        ...
                        <div class="product-content">
                            ...
                            <p class="pull-left">${{$item->product_price}}</p>
                            <ul class="pull-right d-flex">
    ...
    <section class="social-newsletter-section" id="nasrin">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
