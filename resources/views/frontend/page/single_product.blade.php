...
@section('body')
    ...
    @include('frontend.component.breadcum', ['pageName' => $product->name])
                ...
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            <div class="item">
                                <img src="{{ asset($product->product_image ?? 'avator.png') }}" alt="">
                            </div>

                            @foreach ($product->product_images as $multi_images)
                                <div class="item">
                                    <img src="{{ asset($multi_images->multi_images ?? 'avator.png') }}" alt="">
                                </div>
                            @endforeach
                                ...
                                <ul>
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{ asset('frontend/assets/images/comment/1.png') }}"
                                                alt="">
                                        </div>
                                    ...
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{ asset('frontend/assets/images/comment/2.png') }}"
                                                alt="">
                                        </div>
                                        <div class="review-content">
                                    ...
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{ asset('frontend/assets/images/comment/3.png') }}"
                                                alt="">
                                        </div>
                                        <div class="review-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            <div class="product-img">
                                <span>Sale</span>
                                <img src="{{ asset($item->producy_image ?? 'avator.png') }}" alt="">
