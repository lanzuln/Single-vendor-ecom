            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <ul class="d-flex account_login-area">
                        ...
                        @guest
                            <li><span><a href="{{ route('customer.login') }}"> Login</a></span></li>
            ...
            <div class="row">
                        ...
                        <ul class="d-flex">
                            ...
                            <li>
                                ...
                                <ul class="dropdown_style">
                                    ...
                                    <li><a href="{{ route('shopping.cart.page') }}">Shopping cart</a></li>
                                    <li><a href="checkout.html">Checkout</a></li>
                                    <li><a href="wishlist.html">Wishlist</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-md-4 col-lg-2 col-sm-5 col-4">
                    <ul class="search-cart-wrapper d-flex">
                        ...
                        <li>
                            @php
                                $cartItem = \Gloudemans\Shoppingcart\Facades\Cart::count();
                                $carts = \Gloudemans\Shoppingcart\Facades\Cart::content();
                                $total = \Gloudemans\Shoppingcart\Facades\Cart::subtotal();
                            @endphp
                            <a href="javascript:void(0);"><i class="flaticon-shop"></i>
                                <span>{{ $cartItem }}</span></a>
                            <ul class="cart-wrap dropdown_style">
                                @foreach ($carts as $item)
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{ asset($item->options->product_image ?? 'avator.png') }}" alt=""
                                                class="img-fluid  rounded" width="60px">
                                        </div>
                                        <div class="cart-content">
                                            <a href="cart.html" class="text-white">{{ $item->name }}</a>
                                            <span>QTY : {{ $item->qty }}</span>
                                            <p>${{ $item->price * $item->qty }}</p>
                                            <a href="{{ route('shopping.cart.remove', $item->rowId) }}"><i
                                ...
                                <li>
                                    <a href="{{ route('shopping.cart.page') }}"><button>Check Out</button></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
